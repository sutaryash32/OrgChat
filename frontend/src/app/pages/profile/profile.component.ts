...
@Component({
  ...
  styles: [`
    ...
    .profile-avatar {
      ...
      margin: 0 auto 16px; box-shadow: 0 8px 24px rgba(99,102,241,0.2);
    }

    .profile-name { font-size: 1.5rem; font-weight: 700; margin: 0 0 4px; color: #1a1a2e; }
    .profile-merid { color: #6366f1; margin: 0 0 4px; font-size: 0.9rem; }
    .profile-email { color: #9ca3af; margin: 0 0 16px; font-size: 0.85rem; }
    ...
    .role-badge { background: rgba(99,102,241,0.1); color: #6366f1; }
    .sso-badge { background: rgba(16,185,129,0.1); color: #059669; }

    .media-section { max-width: 800px; margin: 0 auto; }
    .media-section h2 {
      font-size: 1.1rem; font-weight: 600; margin: 0 0 16px; color: #6b7280;
    }
    ...
    .media-card:hover { transform: translateY(-4px); box-shadow: 0 8px 16px rgba(0,0,0,0.08); }

    .media-thumb { width: 100%; height: 140px; object-fit: cover; }

    .media-file-icon {
      height: 140px; display: flex; align-items: center; justify-content: center;
      color: #d1d5db; background: #fafbfc;
    }

    .media-card-info { padding: 12px; }
    .media-name { display: block; font-size: 0.8rem; font-weight: 500; color: #1a1a2e; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .media-size { display: block; font-size: 0.7rem; color: #9ca3af; margin-top: 2px; }

    .no-media { color: #9ca3af; text-align: center; grid-column: 1 / -1; }
